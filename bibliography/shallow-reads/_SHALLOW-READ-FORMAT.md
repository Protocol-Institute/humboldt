...
{1–2 sentences: type of work (paper/post/report), main argument or contribution, primary domain.}

## What I took from it

{1–3 paragraphs: what's relevant to the new nature research agenda. Not a summary of the whole
work — focus on the intersection with Humboldt's laws, hypotheses, and methods. What did it
confirm, challenge, or open? What patterns does it instantiate?}

## Research connections

- **{law or hypothesis ID}:** {one sentence on the connection}
- **{law or hypothesis ID}:** {one sentence on the connection}
