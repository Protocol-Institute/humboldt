...
**Type:** imported
**Phase:** valley
**Phase artifact:** T-004 (Gall) — source law in heavy lift; protocol-theoretic CL pending from valley
...
- Is Gall's Law specifically about the implicit solution problem, or also about the adoption-momentum problem (F-001)? The two may be compounding.
...
- [x] Law YAML registered → `research/f/F-004-gall.yaml`
